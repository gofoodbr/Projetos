...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  void initState() {
    ...
    companyScreenBloc.allproductspromoIn([]);
        ...
        slivers: <Widget>[
                      ...
                      Container(
                        ...
                        children: <Widget>[
                          Padding(
                              ...
                              child: Center(
                                  child: CircleAvatar(
                                radius: ScreenUtil().setHeight(70),
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              StreamBuilder(
                  stream: companyScreenBloc.allproductspromoOut,
                  builder: (context, snapshot) {
                    return companyScreenBloc.getAllProductsPromo().length == 0
                        ? Container()
                        : ProductsPromo(snapshot.data);
                  }),
