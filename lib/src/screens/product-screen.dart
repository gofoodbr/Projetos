    ...
    return WillPopScope(
      ...
      child: StreamBuilder<Product>(
        ...
        builder: (context, snapshot) {
          ...
          Image image;
          if(snapshot.data.contentType =="image/jpeg" ||snapshot.data.contentType =="image/png"){
            image = Image.memory(base64Decode(snapshot.data.content), fit: BoxFit.fitWidth);
          }
          return Scaffold(
            key: _scaffoldKey,
                ...
                Container(
                  child: Row(
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[ 
                              Text("Marque os sabores que deseja",
                                style: GoogleFonts.poppins(
                                  color: Colors.black,
                      ...
                      Text("${product.sabores.length}/${product.maximoSabores}",
                        style: GoogleFonts.poppins(
                          color: Colors.black,
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: <Widget>[
                                      Text("Escolha quantos sabores deseja",
                                        style: GoogleFonts.poppins(
                                          color: Colors.black,
                                          fontSize: ScreenUtil().setSp(26),
                                        ),
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      int quantidade = product.sabores.where((opcional)=> snapshot.data[index].saborProdutoId == opcional.saborProdutoId).length;
                      double precoSabor = 0;
                      if(snapshot.data[index].valorTotal != null){
                        precoSabor = double.parse(snapshot.data[index].valorTotal);
                      }
            ...
            children: <Widget>[
              Container(
                child: Row(
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: <Widget>[ 
                            Text("Marque o opcional que deseja",
                              style: GoogleFonts.poppins(
                                color: Colors.black,
                                fontSize: ScreenUtil().setSp(23),
                              ),
                    ...
                    Text("${product.opcionais.length}/${product.maximoOpcionais}",
                      style: GoogleFonts.poppins(
                        color: Colors.black,
                        fontSize: ScreenUtil().setSp(26),
                      ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: snapshot.data.length,
                  itemBuilder: (context, index){
                    int quantidade = product.opcionais.where((opcional)=> snapshot.data[index].composicaoProdutoId == opcional.composicaoProdutoId).length;
                    return GestureDetector(
                      onTap: (){
                        itemBloc.addOpcionais(snapshot.data[index]);
                      },
                      child: Column(
                        children: <Widget>[
                          Container(
            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text("Marque o complemento que deseja",
                          style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontSize: ScreenUtil().setSp(23),
                          ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: snapshot.data.length,
                  itemBuilder: (context, index){
                    int quantidade = product.complementos.where((complemento)=> snapshot.data[index].complementoProdutoId == complemento.complementoProdutoId).length;
                    return Container(
                      child: Column(
                        children: <Widget>[
                          Container(
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      children: <Widget>[
                                        Text(snapshot.data[index].produtoComplemento.nomeAbreviado,
                                          style: GoogleFonts.poppins(
                                            color: Colors.black,
                                            fontSize: ScreenUtil().setSp(30),
                                          ),
                                    ...
                                    Row(
                                      children: <Widget>[
                                        Text("+ ${formatPrice(double.parse(snapshot.data[index].produtoComplemento.precoVenda))}  ",
                                          style: GoogleFonts.poppins(
                                            color: Colors.grey,
                                            fontSize: ScreenUtil().setSp(27),
                                          ),
                                        ),
                                        snapshot.data[index].obrigatorio? Container(
                                          decoration: BoxDecoration(
                                            color: primaryColor,
                                ...
                                Expanded(child: Container()),
                                quantidade == 0 ? Container() : IconButton(
                                  icon: Icon(
                                    Icons.remove,
                                    color: primaryColor,
                                    size: ScreenUtil().setHeight(30),
                                  ...
                                  onPressed: (){
                                    itemBloc.removeComplemento(snapshot.data[index]);
                                  }
                                ),
                                quantidade == 0 ? Container() : Text("${quantidade.toString()}"),
                                IconButton(
                                  icon: Icon(
                                    Icons.add,
                                    color: primaryColor,
                                  ...
                                  onPressed: (){
                                    itemBloc.addComplemento(snapshot.data[index]);
                                  }
                                ),
                                SizedBox(
                                  width: ScreenUtil().setWidth(20),
    ...
    return StreamBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        if(product.company.preferenciaMaiorPrecoSabor && product.sabores.length > 0){
          ...
          precoProduto = double.parse(product.precoVenda) : precoProduto = double.parse(product.precoVendaPromocional) ;
        }
        ...
        if(complementos != null){
          complementos.forEach((f){
            valorComplementos = valorComplementos + double.parse(f.produtoComplemento.precoVenda);
          });
        }
        return Container(
              ...
              children: <Widget>[
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Container(
                          child: Center(
                            child: Text(product.quantidade.toString(),
                              style: TextStyle(
                                fontSize: ScreenUtil().setSp(30)
                              ),
                            ),
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: (){
                      String result = itemBloc.addCarrinho(appBloc, obsController.text);
                      if(result == null){
                            ...
                            showRoundedModalBottomSheet(
                              ...
                              builder: (context){
                                return Container(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      Text("Você possui produtos de outra empresa no carrinho",
                        ...
                        showErrorBtn(
                          onTap: (){
                            if(result == "Você possui produtos de outra empresa no carrinho, clique aqui para limpar"){
                              appBloc.carrinhoIn([]);
                              showError(
                                scaffoldKey: _scaffoldKey,
                                message: "Carrinho Limpo",
                    ...
                    child: Container( 
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Expanded(child: Container()),
                          Text(formatPrice((precoProduto + valorComplementos) * product.quantidade),
                            style: GoogleFonts.poppins(
                              color: Colors.white,
                              fontSize: ScreenUtil().setSp(30)
                            ),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            formatPrice(double.parse(product.precoVenda)) : formatPrice(double.parse(product.precoVendaPromocional)),
            style: GoogleFonts.poppins(
          ...
          StreamBuilder<List<Sabor>>(
            stream: itemBloc.saboresOut,
            builder: (context, snapshot) {
              if(!snapshot.hasData || snapshot.data.length == 0 || !product.company.preferenciaMaiorPrecoSabor){
                return Container();
              }
              return Container(
                ...
                child: Text("Importante: A pizza de mais de 1 sabor será cobrada pelo preço do valor mais caro",
                  style: GoogleFonts.poppins(
                    color: Colors.black,
                    fontSize: ScreenUtil().setSp(27)
                  ),
