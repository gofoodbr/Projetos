...
class _RegisterEnderecoScreenState extends State<RegisterEnderecoScreen> {
  ...
  void initState() {
    ...
    bloc.getEndereco(appBloc.location.latitude.toString(), appBloc.location.longitude.toString()).then((endereco){
      if(endereco != null){
