...
class HistoricoPedido extends StatefulWidget {
  ...
  const HistoricoPedido({Key key, this.pedidoId, this.pedidoOld})
      : super(key: key);
...
class _HistoricoPedidoState extends State<HistoricoPedido> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              FlatButton(
                                  onPressed: () async {
                                    historicoBloc.avaliarPedido(
                                        avaliacao.toInt(), descController.text);
                                    Navigator.pop(context);
                                  },
                                  color: primaryColor,
                                  child: Container(
  ...
  Widget _buttons(
      Pedido pedido, BuildContext context, HistoricoBloc historicoBloc) {
    ...
    return Column(
      children: <Widget>[
        status == 5
            ...
            : Container(),
        isOpen &&
                pedido.empresa.telefone != null &&
                pedido.statusPedidoId != 1 &&
                pedido.statusPedidoId != 3
            ? FlatButton(
                onPressed: () async {
  ...
  Widget _header(Pedido pedido) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "$hour:$min",
                    style: TextStyle(
                        color: primaryColor, fontSize: ScreenUtil().setSp(46)),
                  ),
                  SizedBox(
                    height: ScreenUtil().setHeight(10),
                  ),
    ...
    Image image;
    if (pedido.empresa.contentType == "image/jpeg" ||
        pedido.empresa.contentType == "image/png") {
      image = Image.memory(base64Decode(pedido.empresa.content),
          fit: BoxFit.fitWidth);
    }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          statusId != 0 && statusId != 1 && statusId != 2 && statusId != 5
              ? Text(
                  "Realizado às ${data.hour}:${data.minute} - ${data.day}/${data.month}/${data.year}",
                  style: TextStyle(
                      color: Colors.black54, fontSize: ScreenUtil().setSp(27)),
                )
              : Container(),
            ...
            child: Center(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    !historicoBloc.showAll &&
                            pedido.historicoStatusPedidos.length > 1
                ...
                ListView.builder(
                  ...
                  itemCount: !historicoBloc.showAll &&
                          pedido.historicoStatusPedidos.length > 1
                      ? 0
                      : pedido.historicoStatusPedidos.length - 1,
                  itemBuilder: (context, index) {
                    DateTime dateIndex = DateTime.parse(pedido
                        .historicoStatusPedidos[index].dataHistoricoPedido);
                    String hourIndex = dateIndex.hour < 10
                        ? "0${dateIndex.hour}"
                        : dateIndex.hour.toString();
                    String minIndex = dateIndex.minute < 10
                        ? "0${dateIndex.minute}"
                        : dateIndex.minute.toString();
                    return Container(
                      margin:
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text(
                              "${"$hourIndex:$minIndex"} - ${pedido.historicoStatusPedidos[index].descricao}",
                              style: TextStyle(
                                  color: Colors.black45,
                          ...
                          index == 0
                              ? GestureDetector(
                                  ...
                                  child: Icon(!historicoBloc.showAll
        ...
        return Column(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                Text(
                  '${double.parse(item.quantidade).truncate().toString()}',
                  style: TextStyle(
                    color: Colors.black,
                ...
                Text(
                  formatPrice(double.parse(item.valorTotal)),
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: ScreenUtil().setSp(32),
                  ),
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              formatPrice(double.parse(pedido.subTotal)),
              style: TextStyle(
                color: Colors.grey,
                fontSize: ScreenUtil().setSp(32),
              ),
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              formatPrice(double.parse(pedido.valorFrete)),
              style: TextStyle(
                color: Colors.grey,
                fontSize: ScreenUtil().setSp(32),
              ),
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              formatPrice(double.parse(pedido.valorDesconto)),
              style: TextStyle(
                color: Colors.grey,
                fontSize: ScreenUtil().setSp(32),
              ),
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              formatPrice(double.parse(pedido.valorTotal)),
              style: TextStyle(
                color: Colors.black,
                fontSize: ScreenUtil().setSp(35),
              ),
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            Image.network(
              "$urlApi/${pedido.formaPagamentoDelivery.imagemUrl}",
