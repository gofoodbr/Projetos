                ...
                child: Center(
                  child: GestureDetector(
                    onTap: () {
                      ...
                      if (appBloc.getPayment().formaPagamentoDeliveryId == 2 &&
                          valorTotal +
                    ...
                    child: Container(
                        decoration: BoxDecoration(
                            color:
                                snapshot.hasData ? primaryColor : Colors.grey,
                ...
                : ListView(
                    ...
                    children: <Widget>[
                      ...
                      StreamBuilder<FormaPagamentoDelivery>(
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData ||
                                snapshot.data.formaPagamentoDeliveryId != 2) {
                              return Container();
                            }
                            return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, "/troco_screen")
                                    .then((_) {
                                  setState(() {});
                                });
                              },
                                  ...
                                  child: ListView(
                                    ...
                                    children: <Widget>[
                                      ListTile(
                                        ...
                                        title: Text(
                                          snapshot.data.pagamentoEntrega == true
                                              ? snapshot.data.nome
                                              : appBloc
                                                  .getCardSelected()
                                                  .numeroCartao,
