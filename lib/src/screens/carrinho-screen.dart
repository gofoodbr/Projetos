    ...
    return Scaffold(
                ...
                child: GestureDetector(
                  onTap: (){
                    ...
                    if(appBloc.cupom != null){
                      valorDesconto = (double.parse(appBloc.cupom.descontoPremiacao)/100) * valorTotal;
                    }

                    if(appBloc.getPayment().formaPagamentoDeliveryId == 2 && valorTotal + double.parse(appBloc.getCarrinho()[0].company.valorFrete) - valorDesconto - appBloc.cashback > appBloc.troco){
                                  ...
                                  StreamBuilder(
                                    ...
                                    builder: (context, snapshot){
                                      return Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: <Widget>[
                                          Text(snapshot.data[0].identificacao,
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: ScreenUtil().setSp(32)
                                            ),
                                          ),
                                          Text("${snapshot.data[0].logradouro}, ${snapshot.data[0].numero}",
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: ScreenUtil().setSp(32)
                                            ),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  FlatButton(
                                    onPressed: (){
                                      Navigator.pop(context);
                                      appBloc.confirmPedido().then((value){
                                        if(value != null){
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color:  snapshot.hasData ? primaryColor : Colors.grey,
                      borderRadius: BorderRadius.circular(10)
                    ),
                    child: Center(
                      child: Text(
                        appBloc.convidado ? "Entre com alguma conta" :
                        !snapshot.hasData ? "Escolha uma forma de pagamento" : "Finalizar pedido",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: ScreenUtil().setSp(32)
                        ),
                    ...
                    width: ScreenUtil.screenWidthDp - ScreenUtil().setWidth(50)
                  ),
                ),
              ),
            ),
      ...
      body: StreamBuilder<int>(
        ...
        builder: (context, snapshot) {
          ...
          return appBloc.getCarrinho().length==0 ? Container(): ListView(
            shrinkWrap: true,
            children: <Widget>[
              Container(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context, "/list_enderecos");
                          },
                          child: Row(
                            children: <Widget>[
                              Icon(Icons.pin_drop,
                        ...
                        Row(
                          children: <Widget>[
                            Text("Agora, ${appBloc.getCarrinho()[0].company.tempoMinimoEntrega} - ${appBloc.getCarrinho()[0].company.tempoMaximoEntrega}",
                              style: TextStyle(
                                color: Colors.black54,
                                fontSize: ScreenUtil().setSp(30)
                              ),
                            ...
                            Text("${formatPrice(double.parse(appBloc.getCarrinho()[0].company.valorFrete))}",
                              style: TextStyle(
                                color: Colors.black54,
                                fontSize: ScreenUtil().setSp(30)
                              ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(appBloc.getCarrinho()[0].company.empresaNome,
                      style: GoogleFonts.poppins(
                        color: Colors.black,
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index){
                        ...
                        for(Complemento complemento in product.complementos){
                          listaComplementos.add(
                            Text("1x ${complemento.produtoComplemento.descricaoProduto}",
                              style: TextStyle(
                                color: Colors.grey
                              ),
                            )
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        width: ScreenUtil.screenWidthDp - ScreenUtil().setWidth(280),
                                        child: Text(
                                  ...
                                  PopupMenuButton<String>(
                                    onSelected: (value){
                                      ...
                                      if(appBloc.getCarrinho().length==1){
                                        Navigator.pop(context);
                                      }

                                      List<Product> listaProdutos = appBloc.getCarrinho();

                                      Product value = listaProdutos.firstWhere((produto)=> produto.produtoId==product.produtoId);
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            companyScreenBloc.addCompany(appBloc.getCarrinho()[0].company);
                        ...
                        Column(
                          children: <Widget>[
                            ...
                            appBloc.cupom == null? Container() : Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text(
                            ...
                            appBloc.cashback == 0 ? Container() : Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text(
                                  "Cashback",
                            ...
                            appBloc.getCarrinho()[0].company.descontoGofood == null ? Container() : Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text(
                                  "Desconto da loja",
                                ...
                                appBloc.getCarrinho()[0].company.descontoGofood != "null" ? Text(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  formatPrice(getTotal(
                                    ...
                                    descontoCupom: double.parse(appBloc.cupom?.descontoPremiacao??"0") / 100,
                                    descontoLoja: double.parse(appBloc.getCarrinho()[0].company.descontoGofood == "null"? "0" : appBloc.getCarrinho()[0].company.descontoGofood)/ 100,
                                    frete: double.parse(appBloc.getCarrinho()[0].company.valorFrete),
                                  )),
                                  style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: ScreenUtil().setSp(33),
              ...
              GestureDetector(
                onTap: (){
                  Navigator.pushNamed(context, "/cupom_screen").then((_){
                    setState(() {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(child: Container()),
                      appBloc.cupom == null? Container() : IconButton(
                        onPressed: (){
                          appBloc.cupom = null;
                          setState(() {
              ...
              GestureDetector(
                onTap: (){
                  Navigator.pushNamed(context, "/cashback_screen").then((_){
                    setState(() {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(child: Container()),
                      appBloc.cashback == 0? Container() : IconButton(
                        onPressed: (){
                          appBloc.cashback = 0;
                          setState(() {
              ...
              StreamBuilder<Payment>(
                ...
                builder: (context, snapshot) {
                  ...
                  return GestureDetector(
                    onTap: (){
                      Navigator.pushNamed(context, "/troco_screen").then((_){
                        setState(() {
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("Troco para: ${formatPrice(appBloc.troco)}",
                                style: GoogleFonts.poppins(
                                  color: Colors.black,
                                  fontSize: ScreenUtil().setSp(35)
                                ),
