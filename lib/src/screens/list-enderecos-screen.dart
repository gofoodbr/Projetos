    ...
    return Scaffold(
      key: _scaffoldKey,
       floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.pushNamed(context, "/register_endereco").then((result)async{
            if(result != null){
              appBloc.loadIn(100);
              ...
              builder: (context, snapshot){
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    return enderecoTile(snapshot.data[index], selected: index == 0, appBloc: appBloc, index: index);
                  },
                );
              },
            ),
...
Widget enderecoTile(EnderecoModel enderecoModel, {bool selected, AppBloc appBloc, int index}){
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              Text(enderecoModel.identificacao,
                style: GoogleFonts.poppins(
          ...
          Text("${enderecoModel.logradouro}, ${enderecoModel.numero} - ${enderecoModel.bairro}, ${enderecoModel.cidade} - ${enderecoModel.uf.toUpperCase()}",
            style: GoogleFonts.poppins(
              color: Colors.black54
            ),
          )
